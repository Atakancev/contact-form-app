...
**Turkish (`tr`), German (`de`), Spanish (`es`), Spanish (Mexico) (`es_MX`), French (`fr`), French (Canada) (`fr_CA`), Italian (`it`), and Portuguese (`pt`) Purchases & Refunds have been refreshed to the August 28 canonical meaning. The remaining 17 localized Purchases & Refunds pages require refresh in the prescribed locale order.**
...
1. Portuguese (Brazil) (`pt_BR`) — Purchases & Refunds
2. Russian (`ru`) — Purchases & Refunds
3. Japanese (`ja`) — Purchases & Refunds
4. Korean (`ko`) — Purchases & Refunds
5. Chinese (`zh`) — Purchases & Refunds
6. Chinese Simplified (`zh_Hans`) — Purchases & Refunds
7. Chinese Traditional (`zh_Hant`) — Purchases & Refunds
8. Arabic (`ar`) — Purchases & Refunds
9. Dutch (`nl`) — Purchases & Refunds
10. Swedish (`sv`) — Purchases & Refunds
11. Norwegian Bokmål (`nb`) — Purchases & Refunds
12. Polish (`pl`) — Purchases & Refunds
13. Thai (`th`) — Purchases & Refunds
14. Vietnamese (`vi`) — Purchases & Refunds
15. Ukrainian (`uk`) — Purchases & Refunds
16. Hindi (`hi`) — Purchases & Refunds
17. Indonesian (`id`) — Purchases & Refunds
...
- Canonical rendered Purchases & Refunds and the canonical Markdown source were corrected on August 28. Turkish, German, Spanish, Spanish (Mexico), French, French (Canada), Italian, and Portuguese Purchases & Refunds have now been refreshed. During the French and French (Canada) refreshes, pre-existing parity gaps were also corrected by restoring the canonical required-updates/supported-versions section. Italian and Portuguese already contained that canonical section and were refreshed for Diamond withdrawal treatment, real-money price transparency, and source-date parity. Remaining localized Purchases pages must be updated in locale order before they return to `Ready` parity.
- A fresh August 28 verification still shows Apple requiring purchased in-game currency not to expire and restore support for restorable purchases, while Xsolla continues to identify the transaction-specific Refund Policy at checkout and its legal index lists the Refund Policy dated June 16, 2026.
...
- French (Canada) EU virtual-currency regression coverage: `453315e`
- French Purchases EU virtual-currency refresh: `7f36140`
- French Purchases supported-version parity fix: `9b3acf4`
- French EU virtual-currency regression coverage: `edca411`
- Spanish (Mexico) Purchases EU virtual-currency refresh: `fbacb96`
- Spanish (Mexico) EU virtual-currency regression coverage: `61e7583`
- Spanish Purchases EU virtual-currency refresh: `50f42fc`
- Spanish EU virtual-currency regression coverage: `b7f7791`
...
Full-document localization progress: **83 / 100 current (83%)** across the 25 requested locales. All **25 / 25 localized legal hubs exist (100%)**.
...
**Exact next unfinished locale/document: Portuguese (Brazil) (`pt_BR`) — Purchases & Refunds.**