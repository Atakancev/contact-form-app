...
Swedish (`sv`) is now **1/4**: Terms Ready; Purchases & Refunds, Privacy, and Community Standards Pending.

The next unfinished locale/document is **Swedish (`sv`) Purchases & Refunds Policy**.

### Repository reconciliation, August 27, 2026

Tracker state is reconciled against actual repository pages rather than presumed completion. Full pages exist and are routed for every completed locale above. Swedish now has a complete Terms page at `app/tycoonx-legal/sv/terms/page.tsx`; the Swedish hub routes its Terms card to that localized page while the remaining three Swedish cards continue to fall back to the canonical English documents until translated.
...
- Google Play Developer API release notes dated **July 6, 2026** describe a collaborative chargeback-review flow. A `PendingRefundReviewNotification` may require a response through `orders.reviewrefund` within **24 hours**, with a developer preference and relevant lawful purchase-usage evidence where available. TycoonX payment operations should preserve proportionate transaction evidence and avoid missing provider response deadlines while respecting privacy law.
...
- The August 27, 2026 recheck of current Apple and Google Play sources did not require another canonical English wording change.
...
Full-document localization progress: **69 / 100 complete (69%)** across the 25 requested locales. All **25 / 25 localized legal hubs exist (100%)**.
...
| 18 | sv | Svenska | Ready | Ready | Pending | Pending | Pending |
