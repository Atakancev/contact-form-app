const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "For digitalt innhold som leveres umiddelbart, for eksempel Diamonds, kan en lovbestemt angrerett opphøre etter at leveringen har startet bare hvis alle lovbestemte vilkår er oppfylt, herunder eventuelt transaksjonsspesifikt uttrykkelig samtykke til at leveringen starter tidlig, bekreftelse på at angreretten dermed går tapt og den avtalebekreftelsen loven krever. Aksept av generelle vilkår erstatter ikke separat samtykke når loven krever det.",
