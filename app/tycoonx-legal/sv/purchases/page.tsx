const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "För digitalt innehåll som levereras omedelbart, exempelvis Diamonds, kan en lagstadgad ångerrätt upphöra efter att leveransen har börjat endast om samtliga lagstadgade villkor är uppfyllda, inklusive eventuellt transaktionsspecifikt uttryckligt samtycke till att prestationen börjar tidigt, bekräftelse av att ångerrätten därmed går förlorad och den avtalsbekräftelse som lagen kräver. Ett godkännande av allmänna villkor ersätter inte separat samtycke när lagen kräver det.",
