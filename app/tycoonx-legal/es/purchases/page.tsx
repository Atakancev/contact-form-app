const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      'Para contenido digital suministrado de inmediato, como un paquete de Diamonds, el derecho legal de desistimiento solo puede extinguirse tras empezar la prestación cuando se cumplan todos los requisitos legales, incluido cualquier consentimiento expreso y específico de la transacción para comenzar anticipadamente, el reconocimiento de la pérdida del derecho y la confirmación contractual necesaria. Aceptar las Condiciones generales no pretende sustituir un consentimiento separado cuando la ley lo exija.',
