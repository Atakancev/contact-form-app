const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      '在歐盟／歐洲經濟區消費者保護規則適用於可購買的遊戲內虛擬貨幣時，TycoonX 將以清楚易懂的方式提供法律要求的真實貨幣價格資訊，包括付費 Diamonds 的真實貨幣價格，以及以可購買 Diamonds 兌換的遊戲內數位內容或服務所對應的真實貨幣價格。CK-Labs 不會利用多層虛擬貨幣、套裝設計或兌換結構來掩蓋實際成本，也不會在適用法律禁止的情況下迫使消費者購買明顯超出其實際需要的多餘虛擬貨幣。',
  ...
  },
  {
    ...
    body: [
      ...
      '對歐盟／歐洲經濟區消費者，CK-Labs 不會僅因已購買的 Diamonds 已記入帳戶，就把它視為數位內容已即時提供並因此自動消滅法定撤回權。如果適用法律對已購買的遊戲內虛擬貨幣提供 14 天法定撤回權，則在法定期間內，尚未使用的已購買 Diamonds 仍受該撤回權保障。',
      '如果 Diamonds 已經使用、轉移，或兌換為數位內容或服務，撤回後的具體後果將依強制性法律及該筆交易的實際情況決定，而不是套用一條籠統的「概不退款」規則。適用的契約銷售方或付款管道可以決定撤回申請的提交或處理流程，但這種職責分配不會取消任何強制性的撤回權。',
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white" lang="zh-Hant">
      <div className="border-b border-white/5 px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-zinc-500 text-sm">繁體中文版本：2026 年 8 月 28 日 · 英語正本：2026 年 8 月 28 日</p>
