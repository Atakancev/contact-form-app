const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Đối với người tiêu dùng tại EU/EEA, khi pháp luật yêu cầu, TycoonX phải hiển thị rõ ràng bằng tiền thật giá của Diamonds trả phí và giá bằng tiền thật của nội dung hoặc dịch vụ kỹ thuật số được chào bán để đổi bằng Diamonds có thể mua. Các lớp tiền ảo, cơ chế quy đổi hoặc cấu trúc gói không được che giấu chi phí thực tế hoặc buộc người tiêu dùng phải mua lượng tiền ảo dư thừa đáng kể mà họ không mong muốn khi pháp luật cấm cách làm đó.",
  ...
  },
  {
    ...
    body: [
      ...
      "Việc Diamonds đã mua được ghi có vào tài khoản TycoonX không tự động làm mất quyền rút khỏi hợp đồng theo luật định nếu quyền đó áp dụng cho giao dịch.",
      "Khi quyền rút khỏi hợp đồng theo luật định trong 14 ngày áp dụng cho tiền ảo trong game đã mua, Diamonds đã mua và chưa sử dụng vẫn thuộc phạm vi quyền đó trong thời hạn luật định.",
      "Đối với Diamonds đã được sử dụng, chuyển giao hoặc đổi lấy nội dung hay dịch vụ kỹ thuật số, hậu quả của việc rút hoặc hoàn tiền được xác định theo pháp luật bắt buộc và hoàn cảnh của giao dịch cụ thể. Chính sách này không áp dụng một quy tắc chung 'không hoàn tiền' cho mọi trường hợp đó.",
      "Apple, Google, Xsolla hoặc nhà cung cấp khác có thể vẫn là kênh thủ tục để gửi yêu cầu rút khỏi hợp đồng hoặc hoàn tiền khi họ là thương nhân ký hợp đồng hoặc kiểm soát giao diện thanh toán liên quan, nhưng việc phân bổ vai trò đó không loại bỏ bất kỳ quyền bắt buộc nào.",
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white" lang="vi">
      <div className="border-b border-white/5 px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-zinc-500 text-sm">Phiên bản tiếng Việt: 28 tháng 8, 2026 · Bản tiếng Anh chuẩn: 28 tháng 8, 2026</p>
