const sections = [
  ...
  },
  {
    ...
    content: (
      <p>
        Your display name, selected avatar, room presence, and messages may be visible to other players in the ChatCity room where you participate. Do not share sensitive personal information in your display name or chat messages.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ChatCity is intended for users who are at least 13 years old. The app collects age during profile setup to support this requirement. If you believe a child has provided personal information, please contact us so we can investigate and take appropriate action.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ChatCity uses Supabase for authentication, database storage, and realtime service functionality. Information is retained for as long as needed to operate the service, provide support, meet legal obligations, or resolve disputes. We apply access controls and database security policies to protect account and gameplay data.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        You may stop using ChatCity at any time. For questions about your information, account deletion, correction requests, or privacy rights, contact us at the address below. We may need to verify your request before completing it.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        We may update this Privacy Policy when ChatCity or applicable requirements change. The updated version will be published on this page with a revised date.
      </p>
    ),
  },
];

export default function ChatCityPrivacyPolicy() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="border-b border-white/5 px-4 py-16">
        <div className="max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-3 py-1 mb-6">
            ...
            <span className="text-indigo-400 text-xs font-medium tracking-wide">ChatCity</span>
          </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-1">
        <p className="text-zinc-400 text-sm leading-relaxed px-6 mb-6">
          This Privacy Policy explains how ChatCity handles information when you use the mobile application.
        </p>
        ...
        <div className="flex gap-4 px-6 pt-8 text-sm">
          <a href="/chatcity-support" className="text-zinc-500 hover:text-zinc-300 underline underline-offset-4 transition">ChatCity Support</a>
