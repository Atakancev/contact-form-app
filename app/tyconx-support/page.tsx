    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-3xl mx-auto px-4 pt-12">
        <div className="rounded-xl border border-white/10 bg-[#111111] p-5">
          <p className="text-xs uppercase tracking-widest text-zinc-500 mb-2">TyconX · CK-Labs</p>
          <h1 className="text-xl font-semibold text-white mb-2">Support & Legal</h1>
          <p className="text-zinc-400 text-sm leading-relaxed mb-4">
            For account, purchase, security, privacy, or gameplay issues, use the form below or email cevikdev@gmail.com.
          </p>
      ...
      <ContactForm initialProject="TyconX" />
    </main>
  );
}
