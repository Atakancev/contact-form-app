...
const canonicalChecks = [
  ...
  [terms, 'may choose never to offer Lifetime VIP again', 'Terms Lifetime VIP may never return'],
  [terms, 'Promotional, gifted, event, test, review, compensation, or free Diamonds and benefits', 'Terms free-grant provenance concept'],
