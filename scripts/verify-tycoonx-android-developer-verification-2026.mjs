...
const checks = [
  ...
  ["seven initial stores", /HONOR App Market[\s\S]*OPPO App Market[\s\S]*Galaxy Store[\s\S]*Palm Store[\s\S]*V-Appstore[\s\S]*GetApps/i],
  ["2027 global expansion", /globally in 2027|2027 global/i],
  ["global Play removal risk", /removed from Google Play globally/i],
  ...
  ["no permanent country hardcode", /Do not hard-code the four-country list/i],
  ...
  ["official Android source", /developer\.android\.com\/developer-verification\/guides/i],
